...
function setup() {
  ...
  colorMode(HSB, 360, 100, 100, 100);
    ...
    colourFrom = color(180, 42, 80, 10);
    colourTo = color(336, 4, 60, 50);
...
function launchProgram() {
  ...
  for(let i = 1; i < layerCount; i++) {
    ...
    bgLayers[i] = new Layer(colourFrom, colourTo, (incrementCol * i),
                            weight, i*0.030, randomGaussian(xCoord, 8),
                            randomGaussian(yCoord, 8));
  }
}
    ...
    if(fgLayers[i].isVisible != true) {
      ...
      if(i % 30 === 0) {
        fgLayers.push(new HighlightLayer(colourHighlight, colourHighlight2,
                                         ...
                                         randomGaussian(xCoord, 5),
                                         randomGaussian(yCoord, 5)));
        // fgLayers.push(new HighlightLayer(colourHighlight, colourHighlight2,
